...
- [x] What steps can you take in your web apps to keep your data secure?
  ...
  You can keep the data inside your app tied to specific users and only let them access it if they are authenticated.

- [x] Describe how web servers work.

  Web servers run code that serves up content when they are queried by someone searching for the IP they have been assigned.
